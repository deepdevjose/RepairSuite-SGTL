...
async function main() {
    const userEmail = 'kevis.salas@jlaboratories.com'
    ...
    const newEmployee = await prisma.empleado.create({
        data: {
            ...
            nombreCompleto: 'Kevis Salas Jimenez',
            ...
            especialidades: JSON.stringify(['Hardware', 'Software']),
            avatar: null
        }
    })
    ...
    console.log('Successfully promoted Kevin/Kevis to Employee!')
}
